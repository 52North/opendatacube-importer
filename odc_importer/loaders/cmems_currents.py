...
# https://nrt.cmems-du.eu/thredds/dodsC/cmems_mod_glo_phy_anfc_merged-uv_PT1H-i.html
...
class CmemsCurrentLoader(BasicLoader):
    """
    ...
    def __init__(self):
        ...
        product_names = os.getenv('CMEMS_CURRENT_PRODUCT_NAMES')
        if product_names:
            self.product_names = product_names.split(' ')
        else:
            self.product_names = ['currents']
    ...
    def create_product_dataset_map(self, global_data_folder):
        ...
        # for idx, subfolder in enumerate(['currents']):
    ...
    def create_product_metadata_eo3(self, odc_product_name):
        ...
        # if odc_product_name.startswith('currents'):
    ...
    # def generate_measurement_dict(df):
    #     measurement_dict = {}
    #     data_vars = list(df.data_vars)[:-1]

    #     for var in data_vars:
    #         path = os.path.abspath(os.path.join('data', 'waves1.nc'))
    #         layer = var
    ...
    def create_dataset_metadata_eo3(self, odc_product_name, dataset):
        ...
        #     measurements = dict.fromkeys(list(current_measurements.keys()))
        #     platform = None
        #     instrument = None
        # else:
        #     logger.error(
        ...
        measurement_dict = {}
        for var in current_measurements.keys():
