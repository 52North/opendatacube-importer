...
class CmemsWavesLoader(BasicLoader):
    """
    ...
    def create_product_dataset_map(self, global_data_folder):
        ...
        # for idx, subfolder in enumerate(['waves']):
    ...
    def create_product_metadata_eo3(self, odc_product_name):
        ...
        #     measurements = waves_measurements
        # else:
        #     logger.error(
    ...
    def create_dataset_metadata_eo3(self, odc_product_name, dataset):
        ...
        # if odc_product_name.startswith('waves'):
        #     measurements = dict.fromkeys(list(waves_measurements.keys()))
        #     platform = None
        #     instrument = None
        # else:
        #     logger.error(
        ...
        measurement_dict = {}
        for var in waves_measurements.keys():
